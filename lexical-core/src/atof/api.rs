...
mod tests {
    ...
    fn atof32_base10_test() {
        ...
        assert_eq!(Err((ErrorCode::InvalidDigit, 0).into()), atof32_slice(b"e"));
        assert_eq!(Err((ErrorCode::InvalidDigit, 0).into()), atof32_slice(b"E"));
        ...
        assert_eq!(Err((ErrorCode::InvalidDigit, 0).into()), atof32_slice(b"e1"));
        assert_eq!(Err((ErrorCode::InvalidDigit, 0).into()), atof32_slice(b"e-1"));
        assert_eq!(Err(ErrorCode::Empty.into()), atof32_slice(b"+"));
        assert_eq!(Err(ErrorCode::Empty.into()), atof32_slice(b"-"));
    ...
    fn atof64_base10_test() {
        ...
        assert_eq!(Err((ErrorCode::InvalidDigit, 0).into()), atof64_slice(b"e"));
        assert_eq!(Err((ErrorCode::InvalidDigit, 0).into()), atof64_slice(b"E"));
        ...
        assert_eq!(Err((ErrorCode::InvalidDigit, 0).into()), atof64_slice(b"e1"));
        assert_eq!(Err((ErrorCode::InvalidDigit, 0).into()), atof64_slice(b"e-1"));
        ...
        assert_eq!(Err(ErrorCode::EmptyFraction.into()), atof64_slice(b".e"));
        assert_eq!(Err((ErrorCode::InvalidDigit, 0).into()), atof64_slice(b"E2252525225"));
        assert_eq!(Err((ErrorCode::InvalidDigit, 0).into()), atof64_slice(b"e2252525225"));
